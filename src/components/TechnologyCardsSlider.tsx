...
const cardData = [
  {
    id: 'iot-edge',
    title: 'IoT & Edge',
    description: 'Connect machines seamlessly using OPC-UA and MQTT gateways to enable secure, real-time data exchange between devices, sensors, and systems. Enhance interoperability, reduce communication delays, and ensure reliable machine connectivity across industrial environments.',
  ...
  },
  {
    id: 'ai-ml',
    title: 'AI & ML Engine',
    description: 'Uses AI and machine learning to transform raw operational data into actionable predictive intelligence, optimization of manufacturing processes. This engine ensures equipment health, boosts throughput, and drives significant operational savings by making operations smarter, not just faster.',
  ...
  },
  {
    ...
    description: 'Seamlessly connects your diverse business systems – from ERP and MES to CRM and PLM – creating a unified data ecosystem. This integration enhances data consistency, streamlines workflows, and provides a single source of truth for critical operational and business insights across your entire organization.',
  ...
  },
  {
    ...
    description: 'Deploy on-premises, in the cloud, or in hybrid environments with full control over your infrastructure. Our flexible architecture adapts to your security requirements, compliance needs, and operational preferences, ensuring seamless integration regardless of your deployment strategy.',
...
export default function TechnologyCardsSlider() {
  ...
  return (
    <div className="block h-[766px] overflow-clip relative shrink-0 w-full" data-name="Cards" style={{ background: 'linear-gradient(242.47deg, #00BCEF 6.45%, #002363 95.13%)' }}>
      {/* Header Content */}
      <div className="absolute content-stretch flex gap-[250px] h-[90px] items-center left-[180px] not-italic text-white top-[70px] w-[1152px]">
        <p className="font-['Gilroy:Semibold',sans-serif] leading-[45px] relative shrink-0 text-[36px] w-[260px]">{`Technology & Integrations`}</p>
        <p className="basis-0 font-['Gilroy:Medium',sans-serif] grow leading-[24px] min-h-px min-w-px relative shrink-0 text-[16px]">Built on a robust, scalable, and secure architecture - Tecosoft Analytics seamlessly integrates with your enterprise ecosystem, combining IoT connectivity, AI analytics, and open APIs to deliver intelligent insights instantly.</p>
          ...
          {cardData.map((card, index) => (
            <SwiperSlide key={card.id}>
              <div className="bg-white h-[368px] relative rounded-[24px] w-full">
                ...
                {/* Card Content */}
                <p className="absolute font-['Gilroy:Semibold',sans-serif] leading-[28px] left-[50px] not-italic text-[#0098d4] text-[28px] text-nowrap top-[50px] whitespace-pre">
                  {card.title}
                </p>
                <p className="absolute font-['Gilroy:Regular',sans-serif] leading-[25px] left-[50px] not-italic text-[#636363] text-[18px] top-[114px] w-[650px]">
                  {card.description}
                </p>
                
                {/* Metrics */}
                <div className="absolute content-stretch flex flex-col gap-[4px] items-start left-[50px] not-italic top-[250px]">
                  <p className="font-['Gilroy:Semibold',sans-serif] leading-[44px] min-w-full relative shrink-0 text-[#282828] text-[42px] w-[min-content]">
                    {card.metric1.value}
                  </p>
                  <p className="font-['Gilroy:Regular',sans-serif] leading-[20px] relative shrink-0 text-[#636363] text-[16px] text-nowrap whitespace-pre">
                    {card.metric1.label}
                  </p>
                </div>
          ...
          >
            <div className="flex flex-row items-center justify-center size-full">
              <div className="box-border content-stretch flex gap-[10px] items-center justify-center px-[24px] py-[10px] relative w-full">
                <p className={`font-['Gilroy:${activeIndex === index ? 'Semibold' : 'Medium'}',sans-serif] leading-[28px] not-italic relative shrink-0 text-[18px] text-nowrap whitespace-pre ${
