  ...
  return (
    ...
    >
      ...
      <div className="absolute left-[180px] top-[205px]">
        ...
        <button
          className="absolute block cursor-pointer left-[272px] overflow-visible size-[26px] top-[32px] transition-transform hover:scale-110"
        ...
        <button
          className="absolute flex items-center justify-center left-[94px] size-[26px] top-[32px] transition-transform hover:scale-110"
        ...
        <button
          className="absolute block cursor-pointer left-[28px] overflow-clip size-[26px] top-[164px] transition-transform hover:scale-110"
          data-name="cloud"
        ...
        <button
          className="absolute block cursor-pointer left-[348px] overflow-visible size-[24px] top-[164px] transition-transform hover:scale-110"
          data-name="vuesax/linear/diagram"
          onMouseEnter={() => setCurrentSlide(1)}
        >
          <div
            className="absolute contents inset-[3.85%]"
            data-name="vuesax/linear/diagram"
          >
            <div
        ...
        <button
          className="absolute block cursor-pointer left-[94px] overflow-visible size-[26px] top-[296px] transition-transform hover:scale-110"
        ...
        <button
          className="absolute block cursor-pointer left-[280px] overflow-visible size-[26px] top-[296px] transition-transform hover:scale-110"
