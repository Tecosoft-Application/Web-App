import svgPaths from "./svg-n40401f847";
...
function Background() {
  return (
    <div className="absolute inset-[33.89%_17.39%_28.41%_66.07%]" data-name="Background">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 250 289">
        <g id="Background">
          <path d={svgPaths.p30530f00} fill="url(#paint0_linear_8_246)" id="Path 1" />
          <path clipRule="evenodd" d={svgPaths.p332ed1f0} fill="var(--fill-0, #FDFDFD)" fillRule="evenodd" id="Path 2" />
          <path d={svgPaths.p2169f1c0} fill="url(#paint1_linear_8_246)" id="Path 3" />
          <path d={svgPaths.p29bf4700} fill="var(--fill-0, #FDFDFD)" id="Path 4" />
          <path d={svgPaths.p28499000} fill="url(#paint2_linear_8_246)" id="Path 5" />
          <path d={svgPaths.pe977b00} fill="var(--fill-0, #FDFDFD)" id="Path 6" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_8_246" x1="196.739" x2="36.8313" y1="62.5649" y2="193.724">
            <stop stopColor="#00B7FF" />
            <stop offset="1" stopColor="#0EB05C" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_8_246" x1="151.327" x2="73.5636" y1="72.8307" y2="112.542">
            <stop stopColor="#00B7FF" />
            <stop offset="1" stopColor="#0EB05C" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint2_linear_8_246" x1="139.944" x2="90.3228" y1="82.9196" y2="99.7832">
            <stop stopColor="#00B7FF" />
            <stop offset="1" stopColor="#0EB05C" />
          </linearGradient>
        </defs>
...
export default function Cards() {
  return (
    <button className="block cursor-pointer relative size-full" data-name="Cards">
      <Frame />
      <Frame7 />
